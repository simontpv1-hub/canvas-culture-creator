          ...
          >
            ...
            {items.length > 0 && (
              <div className="px-6 py-5 border-t border-border">
                ...
                <button className="w-full bg-gold hover:bg-gold-hover text-primary-foreground font-body font-semibold py-3.5 transition-colors text-sm uppercase tracking-wider">
                  Proceed to Checkout
                </button>
